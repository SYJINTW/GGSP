...
def main_gs(scene_name,
    ...
    for frame_offset in range(total_frame):
        ...
        input_gs_path = input_root / f"{scene_name}_res1" / f"dynamic_{input_frame:04d}" / "point_cloud" / "iteration_30000" / "point_cloud.ply" #! Change to your correct path
        output_gs_path = output_root / f"frame_{output_frame:04d}" / "lod0" / "point_cloud" / "iteration_30000" / "point_cloud.ply"
